...
import {Power2, TimelineLite,TimelineMax} from "gsap";
...
const CanvasSlideshow = function( options ) {
    ...
    options.displacementImage   = 'https://olivercox.files.wordpress.com/2016/11/pattern.png?w=624';
//options.hasOwnProperty('displacementImage') ? options.displacementImage : '';
    ...
    const displacementSprite  = new PIXI.Texture.from( options.displacementImage );
    ...
    this.initPixi = function() {
        ...
        if ( options.fullScreen === true ) {
            ...
            renderer.view.style.width     = '225px';
            renderer.view.style.height    = '225px';
    ...
    if ( options.autoPlay === true ) {
       ...
       // let ticker = new PIXI.ticker.Ticker();
        ...
        let render = new PIXI.Ticker();
        //let render = new PIXI.Ticker.shared;
    ...
    this.moveSlider = function( newIndex ) {
        ...
        baseTimeline
            ...
            .to(displacementFilter.scale, 1.5, { x: options.displaceScaleTo[0], y: options.displaceScaleTo[1], ease: Power2.easeOut }, 0.8 );
